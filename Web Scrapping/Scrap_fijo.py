...
def get_data(url):
    ...
    # Estructura de data
    data = {}
    df1 = pd.DataFrame(columns=['Col1', 'Col2', 'Col3', 'Col4']) #Nombres de los header de tabla
...
# aplicar funcion incertando el url a scrapear.
get_data('')
